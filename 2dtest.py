...
while True:
    ...
    if circles is not None:
        ...
        chosen = None
        # print(type(circles[0][0][1].tolist()))
        # for i in circles[0,]:
        #     if chosen is None: 
        #         chosen =i
        ...
        #             chosen = i
        cv2.circle(frame, (circles[0][0][0].tolist(), circles[0][0][1].tolist()), circles[0][0][2].tolist(), (0,100,100) , 3)
        print(len(circles))
        # print(type(frame[circles[0][0][0].tolist()][circles[0][0][1].tolist()].tolist()))
        # prevCircle= chosen
